<template>
  <div class="login flex w-[460px] flex-col p-6 md:p-0">
    <div
      class="login-title mb-[24px] text-[20px] font-semibold leading-normal text-primary"
    >
      ...
      >
        ...
        <div class="mb-[24px] block md:flex">
          ...
          <div class="flex justify-end">
            <div
              class="mr-[4px] flex items-end justify-end rounded-[8px] bg-black text-5xl text-white line-through"
            >
              {{ tempCaptcha }}
            </div>
            <div
