...
const menus = reactive<MainItem[]>([
  ...
  { index: '/gmap', iconName: 'icon_zones', pageName: '監測站總覽' },
  ...
  { index: '/riverlevel', iconName: 'icon_waterLevel', pageName: '河川水位' },
    ...
    { index: '/Earthquakes', iconName: 'icon_search', pageName: '地震儀總覽' },
  {
    ...
    { index: '/forminsert', iconName: 'icon_form', pageName: '電子表單查詢' }
]);
</script>
